...
<script>
  $( function() {
    ...
    $( "#searchInput" ).autocomplete({source: allIngredients});
  } );
  </script>
<meta charset="ISO-8859-1">
<title>${loggedUser.firstName}'s Bar</title>
...
<!-- Ingredient Dropdown -->	
<button type="button" id="button2" class="collapsible"><h5>${pantry.size()} Ingredients</h5></button>
	<div class="content2"  style="height: 70vh;overflow-y: scroll;">
		<c:forEach items="${pantry}" var="ingredient">
    		${ingredient}<br>
		</c:forEach>
	</div>
...
<button type="button" id="button1" class="collapsible"><h5>${suggestions.size()} Suggestions</h5></button>
<div class="content1" style="height: 70vh;overflow-y: scroll;">
...
<!-- Search Results Go Here -->		
	<div class="container1">
    	...
    	<p><c:out value="${error}" /></p>
			...
			<form action="/happyhour/mybar/add" method="post">
				<div class="input-group justify-content-center">
					<div class="ui-widget">
						<input type="text" name="ingredient" id="searchInput" class="form-control" placeholder="add an ingredient">
					</div>
    ...
    <h4 style="color: white; text-align: center;">Here's what you can make now!</h4>
		<div class="row g-3" style="height: 75vh;overflow-y: scroll; margin-top: 10px;">
